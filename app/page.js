        ...
        <header className="rounded-3xl border border-green-100 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">This view keeps menus limited and answers the core questions fast: what should be germinating, taking cuttings, transplanting, or fertilizing right now.</p>
            </div>
